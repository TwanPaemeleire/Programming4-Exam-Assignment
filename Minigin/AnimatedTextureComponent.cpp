...
AnimatedTextureComponent::AnimatedTextureComponent(GameObject* owner)
	:Component(owner)
{
}
...
void AnimatedTextureComponent::Render() const
{
...
void AnimatedTextureComponent::InitializeSpriteSheet(const std::string& filePath, int rows, int columns)
{
...
void AnimatedTextureComponent::PlayAnimation(int row, int amountOfFrames, float frameDelay, int repeatStartColumn)
{
	m_CurrentRow = row;
	m_CurrentColumn = 0;
